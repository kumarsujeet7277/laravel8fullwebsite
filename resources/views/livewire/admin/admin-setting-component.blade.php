                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="" class="form-horizontal" wire:submit.prevent="saveSetting">
                            ...
                            <div class="form-group">
                                <label for="" class="col-md-4 control-label">Pintrest</label>
                                <div class="col-md-4">
                                    <input type="text" placeholder="Pintrest" class="form-control input-md" wire:model="pintrest"/>
                                    @error('pintrest') <p class="text-danger">{{$message}}</p>@enderror
                                </div>
                            </div>
                            <div class="form-group">

        ...
        <div class="row">
            <div class="col-md-12">
                <div id="review_form_wrapper">
                    ...
                    <div id="comments">
                        <h2 class="woocommerce-Reviews-title">Add review for <span></span></h2>
                        <ol class="commentlist">
                            <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                <div id="comment-20" class="comment_container"> 
                                    <img alt="" src="{{ asset('assets/images/products') }}/{{$orderItem->product->image ?? 'code not found'}}" height="80" width="80">
                                    <div class="comment-text">
                                        <p class="meta"> 
                                            <strong class="woocommerce-review__author">{{$orderItem->product->name  ?? 'code not found'}}</strong> 
                                        </p>
                                    </div>
                                </div>
                            </li>
                        ...
                        <div id="respond" class="comment-respond"> 
                            <form  id="commentform" class="comment-form"  wire:submit.prevent="addReview">
                                ...
                                <p class="comment-form-comment">
                                    ...
                                    @error('')<p class="text_danger">{{$message}}</p> @enderror
                                </p>
                                <p class="form-submit">

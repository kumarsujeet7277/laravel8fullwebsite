...
<main id="main" class="main-site">
    ...
    <div class="container">
        ...
        <div class=" main-content-area">
            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    @if (Session::has('coupon'))
                        <p class="summary-info"><span class="title">Discount ({{Session::get('coupon')['code']}})<a href="#" class="fa fa-times text-danger" wire:click.prevent="removeCoupon"></a> </span><b class="index"> - ${{number_format($discount,2)}}</b></p>
            ...
            <div class="wrap-iten-in-cart">
                <h3 class="title-box" style="border-bottom: 1px solid; padding-bottom:15px;">{{Cart::instance('saveForLater')->count()}} items(s) Save For Later</h3>
                ...
                @else
                    <p>No Item Found Save For Later</p>
                @endif
            </div>
